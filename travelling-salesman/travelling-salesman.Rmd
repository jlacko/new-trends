...
```{r raw-data, out.width = '100%', message = F}
...
```{r vzorek, out.width = '100%', message = F}
...
```{r map-crow, out.width = '100%', message = F}
...
```{r distance_matrix-2, out.width = '100%', message = F}
...
```{r time_matrix-2, out.width = '100%', message = F}
