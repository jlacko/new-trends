...
```{r drammatis-personae, message = F}
...
```{r raw-data, out.width = '100%', message = F, warning = F}
...
base_plot <- ggplot() + 
  basemap_gglayer(bars, map_service = "carto", map_type = "light", verbose = F)
...
```{r vzorek, out.width = '100%', message = F, warning = F}
...
```{r crow-flies, out.width = '100%', message = F}
...
```{r solve-crow, out.width = '100%', message = F}
...
```{r map-crow, out.width = '100%', message = F, warning = F}
...
```{r herer, out.width = '100%', message = F}
...
```{r distance_matrix-1, out.width = '100%', message = F}
...
```{r distance_matrix-2, out.width = '100%', message = F, warning = F}
...
```{r time_matrix-1, out.width = '100%', message = F}
...
```{r time_matrix-2, out.width = '100%', message = F, warning = F}
