...
The Traveling Salesman Problem (TSP) @gutin_punnen06 is an optimization classic, with a number of well understood and highly standardized solutions available in the context of statistical programming language R.
...
Solving the TSP for such a matrix is straightforward, as optimization analysis is readily implemented in the `{TSP}` package.
